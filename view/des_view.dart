  ...
  void toggleFavorite(String productId) {
    setState(() {
      if (favoriteItems.contains(productId)) {
        ...
        if (user != null) {
          // Remove item from favorites in Firestore
          _alleventsController.removeFromFavorites(user!.uid, productId);
        }
      } else {
        // Item is not in favorites, add it
        favoriteItems.add(productId);
        if (user != null) {
          // Add item to favorites in Firestore
          _alleventsController.addToFavorites(user!.uid, productId);
        }
      }
    });
  }
